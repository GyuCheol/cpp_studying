...
namespace assignment2
{
	...
	{
		return (unsigned int)((4.f * powf(EULER_NUM, ((float)-GetAllPersonWeight() + 400.f) / 70.f)) + 0.5f);
	}

	unsigned int Airplane::GetFlySpeed()
	{
		return (unsigned int)((200.f * powf(EULER_NUM, ((float)-GetAllPersonWeight() + 800.f) / 500.f)) + 0.5f);
	}
